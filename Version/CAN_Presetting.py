...
class CAN_Presetting(QWidget):
    ...
    def SetUI(self):
        ...
        self.Record_Data = QPushButton('RECORD DATA')
        ...
        self.HB_ShowV1 = QVBoxLayout()
        self.HB_ShowV2 = QVBoxLayout()
        self.HB_ShowV1.addWidget(self.Ped_Show)
        self.HB_ShowV1.addWidget(self.Veh_Show)
        self.HB_ShowV2.addWidget(self.Lane_Show)
        self.HB_ShowV2.addWidget(self.Clear_Show)
        self.HB_Show1.addLayout(self.HB_ShowV1)
        self.HB_Show1.addLayout(self.HB_ShowV2)
